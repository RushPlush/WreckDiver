	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 Specular = 0.5;
				float Metallic = ( 1.0 - tex2D( _Metalic, uv_Metalic ).r );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float time23 = -22.58;
				float2 voronoiSmoothId23 = 0;
				float2 coords23 = input.ase_texcoord4.xy * 43.53;
				float2 id23 = 0;
				float2 uv23 = 0;
				float fade23 = 0.5;
				float voroi23 = 0;
...
ASEEND*/
//CHKSM=60FC9F8D18AF982E31D6A63B29960534FD31AB43